...
public class FarmerMainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrawerLayout drawer = findViewById(R.id.drawer_farmer_layout);
        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(
                this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close);
        drawer.addDrawerListener(toggle);
        toggle.syncState();

        NavigationView navigationView = findViewById(R.id.nav_view_farmer);
        ...
        ManageInventory_Frag manageInventory_Frag = new ManageInventory_Frag();
        FragmentTransaction tx = getSupportFragmentManager().beginTransaction();
        tx.replace(R.id.RelativeLayout_for_Fragment, manageInventory_Frag).commit();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_Inventory) {
            ...
            manager.beginTransaction().replace(R.id.RelativeLayout_for_Fragment, manageInventory_Frag).commit();
            getSupportActionBar().setTitle("Home");
